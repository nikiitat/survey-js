...
describe('Survey suite', function () {
    ...
    it('Opening a survey and the flow of answering questions.', async function () {
        ...
        assert.equal(await surveyPage.questionPageIsDisplayed(2), true, 'Page with question number 2 is not displayed');
        ...
        assert.equal(await surveyPage.questionPageIsDisplayed(3), true, 'Page with question number 3 is not displayed');
        ...
        assert.equal(await surveyPage.questionPageIsDisplayed(4), true, 'Page with question number 4 is not displayed');
        ...
        assert.equal(await surveyPage.questionPageIsDisplayed(5), true, 'Page with question number 5 is not displayed');
        ...
        assert.equal(await surveyPage.questionPageIsDisplayed(6), true, 'Page with question number 6 is not displayed');
        ...
        assert.equal(await surveyPage.questionPageIsDisplayed(7), true, 'Page with question number 7 is not displayed');
        ...
        assert.equal(await surveyPage.questionPageIsDisplayed(8), true, 'Page with question number 8 is not displayed');
        ...
        assert.equal(await surveyPage.questionPageIsDisplayed(9), true, 'Page with question number 9 is not displayed');
        assert.equal(await surveyPage.selectAnswerOnPage(1, 9), true, 'Can not select answer 1 on page 9');
        assert.equal(await surveyPage.goToNextPage(), true, 'Next Button is not displayed on page 9');

        assert.equal(await surveyPage.questionPageIsDisplayed('10b'), true, 'Page with question number 10 is not displayed');
        assert.equal(await surveyPage.selectAnswerOnPage(1, '10b'), true, 'Can not select answer 1 on page 10');
